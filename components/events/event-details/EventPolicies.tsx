...
export function EventPolicies({ policies, setQuoteOpen }: EventPoliciesProps) {
  ...
  return (
    <section id="policies" className="scroll-mt-32 pt-16 md:pt-24 border-t border-gray-100">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10 md:mb-14">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-xl md:text-3xl font-black text-gray-900 tracking-tighter">Essential Policies & Terms</h2>
            <p className="text-[9px] md:text-[11px] font-black text-[#FF9530] uppercase tracking-[0.2em] mt-1">Legally Binding Venue Agreements</p>
          </div>
        </div>
      </div>
