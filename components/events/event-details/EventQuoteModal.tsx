...
export function EventQuoteModal({ isOpen, onClose, initialVenueId }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-[1100] bg-black/95 backdrop-blur-xl flex items-center justify-center p-4 sm:p-6 md:p-10" onClick={onClose}>
      <div className="bg-white rounded-2xl sm:rounded-[2rem] border border-gray-100 shadow-2xl w-full max-w-2xl max-h-[85vh] flex flex-col overflow-hidden animate-in fade-in slide-in-from-bottom-5 sm:zoom-in duration-300" onClick={e => e.stopPropagation()}>
        ...
        {done ? (
          <div className="p-16 text-center overflow-y-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="p-6 sm:p-8 space-y-8 md:space-y-10 overflow-y-auto flex-1 scrollbar-hide">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5">
                  ...
                  {/* Special Message - Spans multiple */}
