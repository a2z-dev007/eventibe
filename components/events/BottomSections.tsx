...
export function ClientStoriesSection() {
  ...
  return (
    <section id="stories" className="scroll-mt-[142px] py-12 md:pt-16 md:pb-10 lg:py-10  bg-white px-4 sm:px-6 lg:px-8 overflow-hidden">
...
export function SeoContentSection() {
  return (
    <section id="about" className="scroll-mt-[142px] py-12 md:py-16 lg:py-12 bg-gray-50/50 px-4 sm:px-6 lg:px-8">
