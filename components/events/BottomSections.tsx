...
export function ClientStoriesSection() {
  return (
    <section className="py-12 md:py-16 lg:py-20 bg-white px-4 sm:px-6 lg:px-8 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 mb-16">
          <SectionHeader
            eyebrow="Success Stories"
            title="Moments That Matter"
            subtitle="Join thousands of happy hosts who found their dream venues through Eventibe."
          />
          ...
          >
            {stories.map((s, idx) => (
              <SwiperSlide key={idx} className="h-auto">
                <article
                  className="group bg-gray-50/50 hover:bg-white rounded-[2.5rem] border border-transparent hover:border-gray-100 p-8 hover:shadow-[0_30px_60px_rgba(0,0,0,0.06)] transition-all duration-500 flex flex-col relative h-full min-h-[400px]"
                >
...
export function SeoContentSection() {
  return (
    <section className="py-12 md:py-16 lg:py-20 bg-gray-50/50 px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <p className="text-gray-500 text-lg leading-relaxed font-medium">
              Eventibe is more than just a booking engine. We are a bridge to unforgettable experiences, helping you discover and book premium wedding venues, banquet halls, resorts, and corporate hubs across India's most vibrant cities.
            </p>
...
export function FaqSection() {
  return <ReusableFaqSection faqs={faqs} />
}
