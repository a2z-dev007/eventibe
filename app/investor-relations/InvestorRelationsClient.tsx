    ...
    <div className="min-h-screen bg-white overflow-hidden selection:bg-[#F97316]/30">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          <FadeUp>
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 backdrop-blur-md mb-8">
              ...
              <span className="text-white/80 text-[10px] font-bold uppercase tracking-[0.25em]">Investor Relations Profile 2026</span>
            </div>
          </FadeUp>
      ...
      <section className="relative py-24 md:py-32 px-6">
        <div className="max-w-7xl mx-auto">
          <SectionHeading title="Market Opportunity — Why Now?" subtitle="Section 01" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-12 mb-16">
               <FadeUp>
                 <h3 className="text-2xl md:text-3xl font-black text-[#0B1F3A] mb-8 flex items-center gap-4">
                   <Globe className="text-[#F97316]" /> 1.1 Global Event Economy Growth
                 </h3>
               </FadeUp>
               
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                 {[
                   { label: "Post-Pandemic Demand", desc: "Rebounding demand for shared experiences." },
                   { label: "Corporate Experiential", desc: "Increasing focus on conferences & marketing." },
                   { label: "Consumer Spending", desc: "Rising budgets for weddings and milestones." },
                   { label: "Digital Behavior", desc: "Increased discoverability and planning online." }
                 ].map((item, i) => (
                   <FadeUp key={i} delay={0.1 * i}>
                     <div className="p-6 rounded-3xl bg-gray-50 border border-gray-100 hover:shadow-lg transition-all duration-300">
                       <p className="font-black text-[#0B1F3A] mb-2">{item.label}</p>
               ...
               <div className="mt-12 grid grid-cols-1 lg:grid-cols-2 gap-8">
                  <FadeUp>
                    <div className="p-8 md:p-10 rounded-[32px] bg-[#0B1F3A] text-white relative overflow-hidden group">
                       ...
                       <h4 className="text-xl font-black mb-6">Live Events Market</h4>
                       <div className="space-y-4">
                          <p className="text-white/60 text-lg">Global value in 2024: <span className="text-white font-black">$1.13 Trillion</span></p>
                          <p className="text-white/60 text-lg">Forecasted 2032: <span className="text-[#F97316] font-black">$1.6 Trillion+</span></p>
                          ...
                          <p className="text-xs text-white/40 italic">CAGR 4.4% expansion forecasted globally.</p>
                       </div>
                    </div>
                  </FadeUp>
                  <FadeUp delay={0.2}>
                    <div className="p-8 md:p-10 rounded-[32px] bg-gradient-to-br from-[#F97316] to-[#EA580C] text-white relative overflow-hidden">
                       <h4 className="text-xl font-black mb-6">Rising Demand For:</h4>
            ...
            <div className="lg:col-span-12">
               ...
               <FadeUp>
                 <h3 className="text-2xl md:text-3xl font-black text-[#0B1F3A] mb-8 flex items-center gap-4">
                   <Building2 className="text-[#F97316]" /> 1.2 India’s Event Economy
                 </h3>
               </FadeUp>
               ...
               <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
                  <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
                    {[
                      { icon: "💍", title: "10 Million+", desc: "Weddings annually in India." },
                      { icon: "💰", title: "$50 Billion+", desc: "Estimated market size for weddings." },
                      { icon: "🏢", title: "Corporate Hub", desc: "Sectors growing due to globalization." },
                      { icon: "🏙️", title: "Tier-2/3 Growth", desc: "Urbanization driving localized demand." }
                    ].map((item, i) => (
                      <FadeUp key={i} delay={0.1*i}>
                        <div className="flex gap-5 p-6 rounded-3xl bg-gray-50 hover:bg-white border border-gray-100 hover:shadow-xl transition-all duration-500">
                          ...
                          <div>
                            <p className="font-black text-[#0B1F3A] text-xl">{item.title}</p>
                            <p className="text-sm text-[#334155]">{item.desc}</p>
                          </div>
                        </div>
                      </FadeUp>
                  ...
                  <FadeUp delay={0.4}>
                    <div className="h-full p-8 md:p-10 rounded-[40px] bg-[#1E3A8A] text-white flex flex-col justify-center">
                       <p className="text-4xl md:text-5xl font-black mb-4">12–15%</p>
                       <p className="text-white/60 font-bold uppercase tracking-widest text-xs mb-6">Growth CAGR Forecast</p>
      ...
      <section className="bg-gray-50 py-24 md:py-32 px-6 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
             <div>
                <SectionHeading title="Digital & Behavioral Trends" subtitle="Section 01.3" />
             ...
             <div>
                <SectionHeading title="Problem Statement" subtitle="Section 02" />
                <div className="p-8 md:p-10 bg-white rounded-[40px] border border-gray-200 shadow-xl relative overflow-hidden">
                   ...
                   <h3 className="text-xl font-black text-[#0B1F3A] mb-8">2.1 Fragmented Discovery Landscape</h3>
                   <div className="space-y-4">
                      {[
                   ...
                   <div className="mt-12 pt-12 border-t border-gray-100">
                      <h3 className="text-xl font-black text-[#0B1F3A] mb-8">2.2 Complexity in Event Services</h3>
                      ...
                      <h3 className="text-xl font-black text-[#0B1F3A] mb-6">2.3 Corporate Event Fragmentation</h3>
      ...
      <section className="py-24 md:py-36 px-6 relative bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto relative z-10">
          <SectionHeading title="Product Architecture & Value Proposition" subtitle="Section 03" />
          
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24">
             <div>
                <FadeUp>
                   <h3 className="text-2xl md:text-4xl font-black text-[#0B1F3A] mb-8 leading-tight">
                     3.1 Dual Brand<br /><span className="text-[#F97316]">Strategy</span>
                   </h3>
                </FadeUp>
          ...
          <div className="mb-20">
             <FadeUp>
                <div className="p-8 md:p-10 rounded-[40px] bg-gradient-to-r from-gray-50 to-white border border-gray-100 shadow-sm">
                   <h3 className="text-xl font-black text-[#0B1F3A] mb-6 flex items-center gap-3"><Globe className="text-[#F97316]" size={20} /> 3.4 Scalable Content Architecture</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
             <TiltCard className="rounded-[40px] bg-[#0B1F3A] text-white p-10 h-full">
                ...
                <ul className="space-y-4 text-white/60">
                   {[
                     "City landing pages",
                     "Event type & capacity filters",
                     "Visual galleries & inquiry forms",
                     "Structured metadata & Schema SEO"
                   ].map((t, i) => (
                     <li key={i} className="flex items-center gap-3">
             ...
             <TiltCard className="rounded-[40px] bg-gray-50 p-10 h-full border border-gray-100 shadow-sm">
                ...
                <div className="flex flex-wrap gap-2 mb-8">
                   {["Catering", "Photography", "Decor", "Lighting", "DJ", "Bridal", "Agencies"].map((v, i) => (
                     <span key={i} className="px-3 py-1 rounded-full bg-white text-[10px] font-bold text-[#334155] border border-gray-100 uppercase tracking-tighter">{v}</span>
                   ))}
                </div>
             ...
             <TiltCard className="rounded-[40px] bg-gradient-to-br from-[#F97316] to-[#EA580C] text-white p-10 h-full">
                ...
                <p className="text-white/80 leading-relaxed mb-8">Higher quality leads with structured details (date, headcount, type).</p>
                <div className="space-y-3">
                   {[
                     "Reduced friction for owners",
      ...
      <section className="py-24 md:py-32 px-6 bg-[#0B1F3A] text-white overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <SectionHeading title="Competitive Landscape" subtitle="Section 04" light />
            ...
            <table className="w-full text-left">
               <thead>
                  <tr className="border-b border-white/10">
                     ...
                     <th className="p-8 font-black text-sm uppercase tracking-widest text-white/40">Inquiry</th>
                     <th className="p-8 font-black text-sm uppercase tracking-widest text-white/40">SEO focus</th>
                     <th className="p-8 font-black text-sm uppercase tracking-widest text-white/40">India Focus</th>
                  </tr>
               </thead>
               <tbody className="divide-y divide-white/5 font-medium">
                  {[
                    { name: "Eventibe.com", marketplace: "Yes", inquiry: "Yes", seo: "Strong", india: "Primary", active: true },
                    { name: "VenueForEvent.com", marketplace: "Yes", inquiry: "Yes", seo: "Strong", india: "Primary", active: true },
                    { name: "WeddingWire", marketplace: "Yes", inquiry: "Yes", seo: "Strong", india: "Limited" },
                    { name: "WedMeGood", marketplace: "Yes", inquiry: "Yes", seo: "Strong", india: "Strong" },
                    { name: "Cvent", marketplace: "Yes", inquiry: "Yes", seo: "Moderate", india: "Global" }
                  ].map((row, i) => (
      ...
      <section className="py-24 md:py-36 px-6 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24">
             {/* Business Model */}
             <div>
                <SectionHeading title="Business Model & Monetization" subtitle="Section 05" />
                <div className="space-y-6">
                   <div className="p-8 rounded-[40px] bg-gray-50 border border-gray-100 group hover:shadow-2xl hover:bg-white transition-all duration-500">
                      <div className="flex items-center gap-4 mb-6">
                         ...
                         <h4 className="text-xl font-black text-[#0B1F3A]">5.1 Lead-Based Revenue</h4>
                      </div>
                   ...
                   <div className="p-8 rounded-[40px] bg-gray-50 border border-gray-100 group hover:shadow-2xl hover:bg-white transition-all duration-500">
                      <div className="flex items-center gap-4 mb-6">
                         ...
                         <h4 className="text-xl font-black text-[#0B1F3A]">5.2 Subscription Plans</h4>
                      </div>
                      <div className="space-y-3">
                         {[
                           "Standard listing (free/basic)",
                           "Featured listing (paid)",
                           "Premium visibility subscription",
                           "City-specific sponsorship packages"
                         ].map((t, i) => (
                           <div key={i} className="flex gap-3 text-[#334155] font-medium text-sm">
                              <span className="text-[#1E3A8A] font-black">{i+1}.</span>
                              <span>{t}</span>
                           </div>
                         ))}
                      </div>
             ...
             {/* GTM Strategy */}
             <div>
                <SectionHeading title="Go-to-Market Strategy" subtitle="Section 06" />
                <div className="space-y-12">
                   {[
                     { 
                       title: "6.1 Organic SEO", 
                       items: ["City landing pages", "Venue categories", "Blog stories", "Schema markup"],
                       color: "border-[#F97316]"
                     },
                     { 
                       title: "6.2 Paid Campaigns", 
                       items: ["Google Ads", "Social campaigns", "Influencer collab"],
                       color: "border-[#1E3A8A]"
                     },
                     { 
                       title: "6.3 Partnerships", 
                     ...
                     <FadeUp key={i} delay={0.2*i}>
                        <div className={`relative pl-8 border-l-4 ${item.color}`}>
                           <h4 className="text-xl font-black text-[#0B1F3A] mb-4">{item.title}</h4>
      ...
      <section className="py-24 md:py-32 px-6 bg-[radial-gradient(circle_at_50%_0%,#0B1F3A,#030a14)] text-white relative overflow-hidden">
         <div className="max-w-7xl mx-auto relative z-10">
            <SectionHeading title="Technology & Scalability" subtitle="Section 07" light />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
               <div className="p-10 rounded-[48px] border border-white/10 backdrop-blur-3xl bg-white/5 relative overflow-hidden group">
                  <h3 className="text-2xl font-black mb-10 flex items-center gap-4">
                     <Rocket className="text-[#F97316]" /> 7.1 Modern Web Stack
                  </h3>
                  <div className="grid grid-cols-2 gap-4">
                     {[
                       { label: "Backend", value: "Django Architecture" },
                       { label: "Frontend", value: "Next.js Performance" },
                       { label: "Admin", value: "Angular Dashboard" },
                       { label: "Architecture", value: "API-First Strategy" }
                     ].map((item, i) => (
                       <FadeUp key={i} delay={0.1*i}>
                  ...
                  <div className="mt-12 flex flex-wrap gap-3">
                     {["Scalability", "SEO-Friendly", "Fast Rendering", "Multi-Brand Support"].map((t, i) => (
                        <span key={i} className="flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#F97316]/20 text-[#F97316] text-[10px] font-bold uppercase tracking-widest border border-[#F97316]/20">
               ...
               <div className="flex flex-col justify-center">
                  <h3 className="text-2xl font-black mb-10 flex items-center gap-4">
                     <Layers className="text-[#2563EB]" /> 7.2 Future Technology Roadmap
                  </h3>
                  <div className="space-y-6">
                     {[
      ...
      <section className="py-24 md:py-36 px-6 bg-white overflow-hidden">
         <div className="max-w-7xl mx-auto">
            <SectionHeading title="Traction, Metrics & Projections" subtitle="Section 08" />
            ...
            <div className="bg-[#0B1F3A] rounded-[48px] p-8 md:p-12 text-white relative overflow-hidden">
               ...
               <h3 className="text-2xl font-black mb-12 flex items-center gap-4">
                  <BarChart3 className="text-[#FBBF24]" /> 8.2 Growth Projections (3–5 Years)
               </h3>
      ...
      <section className="py-24 md:py-36 px-6 bg-gray-50 relative overflow-hidden">
         <div className="max-w-7xl mx-auto">
            <SectionHeading title="Use of Funds" subtitle="Section 09" />
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
               {[
                 { title: "Technology", icon: "🧠", items: ["Scalability", "Search", "CRM platform", "AI/ML recs"] },
                 { title: "Content & SEO", icon: "📍", items: ["City pages", "Venue desc", "Vendor categories", "Blog strategy"] },
                 { title: "Sales & Partners", icon: "🤝", items: ["Team expansion", "Partner liaison", "Lead programs"] },
                 { title: "Marketing", icon: "📢", items: ["Paid campaigns", "Influencers", "Seasonal promo"] }
               ].map((box, i) => (
      ...
      <section className="py-24 md:py-32 px-6 bg-white overflow-hidden">
         <div className="max-w-4xl mx-auto text-center mb-20">
            <SectionHeading title="Risk Analysis & Mitigation" subtitle="Section 10" />
         </div>
       ...
       <section className="py-24 md:py-36 px-6 bg-[#030a14] relative overflow-hidden text-left">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
             <SectionHeading title="Leadership & Team Strength" subtitle="Section 11" light />
       ...
       <section className="py-24 md:py-32 px-6 bg-white overflow-hidden text-left">
          <div className="max-w-7xl mx-auto">
             <SectionHeading title="Strategic Partnerships & Alliances" subtitle="Section 12" />
      ...
      <section className="py-24 md:py-48 px-6 bg-white overflow-hidden text-center relative">
         ...
         <div className="max-w-5xl mx-auto relative z-10">
            <SectionHeading title="Why Invest in Us" subtitle="Section 13" />
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-24">
               {[
                 "Strong growth potential in large market",
            ...
            <FadeUp delay={0.6}>
               <div className="flex flex-col items-center">
                  ...
                  <h3 className="text-2xl md:text-3xl font-black text-[#0B1F3A] mb-8">14. Closing Vision</h3>
