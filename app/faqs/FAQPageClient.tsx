...
const STATIC_FAQS: { [key: number]: FAQ[] } = {
  1: [
    {
      id: 101,
      question: "What is Eventibe?",
      answer:
        "Eventibe is India's leading corporate venue and accommodation booking platform, specifically designed to connect businesses with high-quality spaces for events, meetings, and corporate stays.",
      category_id: 1,
    },
    {
      id: 102,
      question: "How do I search for a venue or stay?",
      answer:
        "Simply use our intelligent search bar on the homepage. You can filter results by city, date, guest count, and specific amenities like high-speed WiFi, conference facilities, or catering services.",
      category_id: 1,
    },
    {
      id: 103,
      ...
      answer:
        "Basic access to the Eventibe platform is completely free. We also offer 'Eventibe Elite'—a premium corporate membership with exclusive corporate rates, priority support, and dedicated account management.",
      category_id: 1,
    },
  ],
  2: [
    {
      ...
      answer:
        "Select your preferred listing, enter the required dates and guest details, and click 'Book Now'. You'll be guided through a secure checkout process to confirm your reservation and receive instant confirmation.",
      category_id: 2,
    },
    {
      id: 202,
      ...
      answer:
        "Cancellation policies are determined by each individual venue or hotel. You can find the specific policy for any listing clearly displayed on its details page before you finalize your booking.",
      category_id: 2,
    },
    {
      id: 203,
      ...
      answer:
        "Yes, most bookings can be modified through your 'My Bookings' dashboard. Please note that modifications are subject to venue availability and may involve a price adjustment based on current rates.",
      category_id: 2,
    },
  ],
  3: [
    {
      ...
      answer:
        "We accept all major credit and debit cards (Visa, MasterCard, American Express), Net Banking, UPI, and Corporate Billing accounts for registered businesses.",
      category_id: 3,
    },
    {
      id: 302,
      ...
      answer:
        "Absolutely. We use industry-standard SSL encryption and PCI-DSS compliant payment gateways to ensure your financial information is never stored and always protected.",
      category_id: 3,
    },
    {
      id: 303,
      ...
      answer:
        "Digital invoices are automatically emailed to your registered address upon successful payment. You can also download them at any time from the 'History' section of your profile.",
      category_id: 3,
    },
  ],
  4: [
    {
      id: 401,
      question: "How can I list my hotel or venue?",
      answer:
        "Click on the 'Become a Host' button in the main navigation. Complete the registration form with your property details, and our verification team will contact you within 24-48 hours.",
      category_id: 4,
    },
    {
      id: 402,
      question: "What are the costs of listing on Eventibe?",
      answer:
        "It is free to list your property on Eventibe. We work on a transparent commission-based model, where a small percentage is deducted from each successful booking made through our platform.",
      category_id: 4,
    },
    {
      id: 403,
      question: "How do I manage my listing inventory?",
      answer:
        "Once approved, you'll gain access to a powerful Partner Dashboard. From there, you can update rates, manage room inventory, respond to inquiries, and track your property's performance.",
      category_id: 4,
    },
  ],
  5: [
    {
      ...
      answer:
        "Quality is our priority. Every listing goes through a comprehensive multi-step verification process, including physical inspections (where applicable) and documentation checks of all corporate partners.",
      category_id: 5,
    },
    {
      id: 502,
      ...
      answer:
        "Our 24/7 Corporate Support team is always ready to help. You can reach out via the 'Support' section in the app, or call our direct emergency helpline listed in your booking confirmation.",
      category_id: 5,
    },
    {
      id: 503,
      ...
      answer:
        "We take security very seriously. Please report any concerns immediately through our dedicated security portal or by emailing security@eventibe.com for an immediate investigation.",
      category_id: 5,
    },
  ],
};
                              ...
                              <div
                                className={`flex-shrink-0 w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-500 ${
                                  isOpen
                                    ...
                                    : "bg-slate-100 text-slate-400 group-hover/faq:bg-slate-200"
                                }`}
                              >
