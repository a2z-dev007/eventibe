  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 scroll-smooth">
      ...
      <CommonHero
        ...
        subtitle="Please read these terms carefully before using our platform. By accessing Eventibe, you agree to be bound by these rules."
      ...
      >
        <div className="flex flex-col items-center mt-4">
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-white/70 hover:text-white mb-6 transition-colors text-sm font-medium group"
          >
            <ArrowLeft
              size={16}
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 text-[10px] md:text-xs text-slate-300 uppercase tracking-[0.2em] font-bold">
