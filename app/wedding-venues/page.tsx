  ...
  return (
    <div className="bg-light-bg min-h-screen py-12">
      <div className="container mx-auto px-4 md:px-6">
        <div className="mb-12">
          <h1 className="text-4xl font-bold text-primary-navy mb-4 tracking-tight">Wedding Venues</h1>
          <p className="text-lg text-soft-slate max-w-3xl">
            Discover the perfect space for your dream wedding. Filter by city, capacity, and amenities to find exactly what you need.
          </p>
        </div>
