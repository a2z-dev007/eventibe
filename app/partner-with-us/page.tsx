...
const formSchema = z.object({
  ...
  about: z
    .string()
    .min(10, "Brief description should be at least 10 characters"),
    ...
    <div className="bg-white min-h-screen font-inter overflow-hidden">
      ...
      <section className="py-16 container mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            At Eventibe, we are not just building a venue listing platform. We
            are building a structured, scalable, and intelligent event
            ecosystem.
          </motion.p>
          <motion.p
            {...fadeInUp}
          ...
          >
            From weddings and luxury celebrations to corporate conferences and
            large-scale exhibitions, Eventibe connects event hosts with venues
            and vendors through a refined inquiry-driven marketplace.
          </motion.p>
          <motion.p
            {...fadeInUp}
          ...
          >
            If you are an agency, corporate group, hospitality brand, wedding
            planner, event management company, media house, or technology
            provider — we invite you to partner with us.
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50 border-y border-gray-100">
        <div className="container mx-auto px-6">
          <div className="text-center mb-10">
            <h2 className="text-4xl md:text-5xl font-extrabold text-primary-navy mb-4">
              Why Partner With Eventibe?
            </h2>
            <p className="text-xl text-soft-slate">
              The event industry is evolving.
            </p>
          </div>
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-12 items-center">
              <div>
                <h3 className="text-2xl md:text-3xl font-bold mb-6">
                  Eventibe is designed to become the bridge between event demand
                  and event supply.
                </h3>
              ...
              <div className="text-center lg:text-left border-t lg:border-t-0 lg:border-l border-white/10 pt-10 lg:pt-0 lg:pl-12">
                <p className="text-xl md:text-2xl font-light italic mb-8">
                  "We are creating a platform where collaboration is stronger
                  than competition."
                </p>
      ...
      <section className="py-16 container mx-auto px-6">
        <div className="text-center mb-10">
          ...
          <p className="text-xl text-soft-slate mb-8">
            Eventibe partnership program is open to:
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          <TiltCard className="group p-8 rounded-[32px] border border-gray-100 bg-white hover:border-corporate-blue/20 transition-all">
            ...
            <p className="text-soft-slate text-sm mb-4">
              If you are a: Wedding planner, Luxury wedding curator, Destination
              wedding specialist, Bridal consultant.
            </p>
            <div className="space-y-2 mt-6">
              <p className="font-bold text-xs uppercase tracking-wider text-gray-400">
                Collaboration Focus:
              </p>
              <ul className="space-y-2">
                {[
                  ...
                  "Vendor coordination",
                  "Lead exchange",
                  "Featured planner profile",
                  "City-wise representation",
                ].map((item) => (
                  <li
                    key={item}
                    className="flex items-center gap-2 text-soft-slate text-sm"
                  >
                    <span className="w-1.5 h-1.5 bg-corporate-blue rounded-full" />{" "}
                    {item}
                  </li>
                ))}
              </ul>
          ...
          <TiltCard className="group p-8 rounded-[32px] border border-gray-100 bg-white hover:border-corporate-blue/20 transition-all">
            ...
            <p className="text-soft-slate text-sm mb-4">
              Managing: Conferences, Seminars, Product launches, Corporate
              training, Award functions, Exhibitions.
            </p>
            <div className="space-y-2 mt-6">
              <p className="font-bold text-xs uppercase tracking-wider text-gray-400">
                Our Support:
              ...
              <ul className="space-y-2">
                {[
                  ...
                  "Quick proposal support",
                  "Bulk venue sourcing",
                  "Dedicated partnership structure",
                ].map((item) => (
                  <li
                    key={item}
                    className="flex items-center gap-2 text-soft-slate text-sm"
          ...
          <TiltCard className="group p-8 rounded-[32px] border border-gray-100 bg-white hover:border-corporate-blue/20 transition-all">
            ...
            <p className="text-soft-slate text-sm mb-4">
              Managing: Banquet halls, Convention centers, Wedding resorts,
              Business hotels, Farmhouses, Luxury properties.
            </p>
            <p className="text-corporate-blue font-bold text-sm mt-6">
              Eventibe can become your digital demand partner.
            </p>
          </TiltCard>
          ...
          <TiltCard className="group p-8 rounded-[32px] border border-gray-100 bg-white hover:border-corporate-blue/20 transition-all">
            ...
            <p className="text-soft-slate text-sm mb-4">
              Handling: Destination weddings, Corporate offsites, MICE events,
              Group travel events.
            </p>
            <div className="space-y-2 mt-6">
              <p className="font-bold text-xs uppercase tracking-wider text-gray-400">
              ...
              <ul className="space-y-2">
                {[
                  "Lead funnel",
                  "Cross-city venue access",
                  "Vendor discovery support",
          ...
          <TiltCard className="group p-8 rounded-[32px] border border-gray-100 bg-white hover:border-corporate-blue/20 transition-all">
            ...
            <p className="text-soft-slate text-sm mb-4">
              Catering, Decor, Lighting, AV, Photography, Mehndi, Tent & theme
              setup companies.
            </p>
            <div className="space-y-2 mt-6">
              <p className="font-bold text-xs uppercase tracking-wider text-gray-400">
          ...
          <TiltCard className="group p-8 rounded-[32px] border border-gray-100 bg-white hover:border-corporate-blue/20 transition-all">
            ...
            <p className="text-soft-slate text-sm mb-4">
              Operating: Wedding blogs, Corporate magazines, Hospitality
              publications, Event social channels.
            </p>
            <div className="space-y-2 mt-6">
              <p className="font-bold text-xs uppercase tracking-wider text-gray-400">
                We Welcome:
          ...
          <div className="flex flex-col md:flex-row items-center text-center md:text-left gap-6">
            ...
            <div>
              <h3 className="text-xl md:text-2xl font-bold text-primary-navy mb-1">
                7. Technology & SaaS Providers
              </h3>
              <p className="text-soft-slate text-sm md:text-base">
                CRM tools, Event software, Virtual platforms, Ticketing,
                Analytics.
              </p>
            </div>
          </div>
          <p className="text-lg md:text-xl font-bold text-corporate-blue text-center">
            Let’s integrate and build a smarter ecosystem.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-10">
            ...
            <p className="text-xl text-gray-300">
              Eventibe believes in flexible and transparent partnership
              structures.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              {
                num: "1",
                title: "Strategic Alliance Partnership",
                ideal:
                  "Large event companies, Multi-city planners, Hospitality groups",
                features: [
              ...
              {
                num: "2",
                title: "Lead Exchange Partnership",
                ideal: "Event planners, Corporate event managers",
                features: [
                  "We share venue leads",
                  "You manage event execution",
                  "Revenue model structured mutually",
                ],
              },
              {
                num: "3",
                title: "Featured Partner Program",
              ...
              {
                num: "4",
                title: "City Representation Partner",
                ideal: "Dominant players in a city's event market",
                features: [
                  "You become city representative",
                  "We route filtered inquiries",
                  "You manage offline execution",
                ],
              },
            ].map((model, idx) => (
              <div
      ...
      <section className="py-16 container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-xl text-soft-slate mb-8">
              Unlike booking portals that focus only on room inventory or
              standard packages, Eventibe is:
            </p>
            <div className="flex flex-wrap gap-4 mb-10">
              {[
                ...
                <span
                  key={tag}
                  className="px-6 py-3 rounded-full bg-blue-50 text-corporate-blue font-bold text-sm border border-blue-100"
                >
                  {tag}
                </span>
              ))}
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-8">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-primary-navy mb-4 tracking-tight">
              How Partnership Process Works
            </h2>
            <p className="text-base text-soft-slate">
              A transparent and structured journey from inquiry to successful
              collaboration.
            </p>
          </div>
              ...
              {[
                {
                  ...
                  details:
                    "Provide your company details, operational cities, and portfolio for initial vetting.",
                  badge: "Discovery",
                  color: "blue",
                },
                {
                  ...
                  details:
                    "Our team conducts a high-level review of your brand alignment and service quality metrics.",
                  badge: "Vetting",
                  color: "orange",
                },
                {
                  ...
                  details:
                    "We finalize the most suitable collaboration model (Subscription, Commission, or Hybrid).",
                  badge: "Strategy",
                  color: "purple",
                },
                {
                  ...
                  details:
                    "We map your profile to target categories and cities, ensuring high search visibility.",
                  badge: "Setup",
                  color: "emerald",
                },
                {
                  ...
                  details:
                    "Your brand becomes active on the Eventibe marketplace, ready to receive qualified leads.",
                  badge: "Launch",
                  color: "rose",
                },
              ].map((item, i) => (
                <div
                  key={i}
                  className={`flex flex-col md:flex-row items-center gap-6 lg:gap-12 ${i % 2 !== 0 ? "md:flex-row-reverse" : ""}`}
                >
                  {/* Content Card Side */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            <div>
              ...
              <div className="p-8 rounded-[40px] bg-white/5 border border-white/10">
                <p className="text-accent-orange font-bold mb-4">
                  For corporations hosting frequent events:
                </p>
                ...
                <p className="text-gray-300">
                  Enterprises, Training companies, Product marketing teams, HR
                  departments.
                </p>
              </div>
            </div>
            <div>
              ...
              <p className="text-xl text-gray-300 mb-8">
                We believe in shared visibility.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  ...
                  <div
                    key={item}
                    className="p-4 rounded-2xl bg-white/5 border border-white/10 text-gray-200 flex items-center gap-3"
                  >
          ...
          <div>
            ...
            <ul className="space-y-4">
              {[
                ...
                <li
                  key={item}
                  className="flex items-center gap-3 text-primary-navy font-medium"
                >
                  <TrendingUp className="w-5 h-5 text-corporate-blue" /> {item}
                </li>
              ))}
            </ul>
            <p className="mt-8 font-bold text-corporate-blue">
          ...
          <div className="bg-gray-50 p-12 rounded-[40px] border border-gray-100">
            ...
            <div className="flex flex-wrap gap-4 mb-8">
              {[
                ...
                <span
                  key={item}
                  className="px-4 py-2 rounded-xl bg-white border border-gray-200 text-sm font-bold text-soft-slate"
                >
                  {item}
                </span>
              ))}
            </div>
            <p className="text-soft-slate mb-6">
              We do not believe in aggressive short-term tactics. We believe in
            ...
            <ul className="space-y-3">
              {[
                ...
                <li
                  key={item}
                  className="flex items-center gap-3 text-soft-slate"
                >
      ...
      {/* Form Section */}
      <section id="partner-form" className="py-16 bg-gray-50/50">
        <div className="container mx-auto px-6">
            ...
            <div className="md:w-1/3 bg-primary-navy p-8 md:p-12 text-white flex flex-col justify-between">
              <div>
                ...
                <p className="text-gray-300 text-sm md:text-base leading-relaxed">
                  If you share the vision of building a structured event
              ...
              <div className="mt-8 md:mt-12">
                <div className="flex -space-x-3 mb-4">
                  {[1, 2, 3, 4].map((i) => (
                    <div
                      key={i}
                      className="w-10 h-10 md:w-12 md:h-12 rounded-full border-4 border-primary-navy bg-gray-600"
                    />
                  ))}
                </div>
                <p className="text-xs md:text-sm font-bold text-accent-orange">
                  Join 200+ growing partners
                </p>
              </div>
            </div>
            ...
            <div className="flex-1 p-8 md:p-12">
              ...
              >
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        ...
                        >
                          <SelectTrigger
                            className={`h-11 rounded-xl ${errors.category ? "border-red-500" : ""}`}
                          >
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="corporate-manager">
                              Corporate Event Manager
                            </SelectItem>
                            <SelectItem value="venue-group">
                              Venue Group
                            </SelectItem>
                ...
                <div className="pt-2">
                  <Button
                    type="submit"
                    className="w-full bg-cta-gradient h-12 md:h-14 rounded-2xl text-base md:text-lg font-bold hover:opacity-90 active:scale-[0.98] transition-all shadow-lg"
                  >
      ...
      <section className="py-16 container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-extrabold text-primary-navy mb-8 text-center px-4 md:px-0">
          ...
          <Accordion type="single" collapsible className="space-y-4">
            <AccordionItem
              value="item-1"
              className="border border-gray-100 rounded-[28px] px-6 md:px-8 bg-white overflow-hidden shadow-sm"
            >
              ...
              <AccordionContent className="text-soft-slate pb-6">
                Cost structure depends on partnership model. Our team will
                discuss based on scale and category.
              </AccordionContent>
            </AccordionItem>
            ...
            >
              ...
              <AccordionContent className="text-soft-slate pb-6">
                Lead volume depends on city demand, category strength, and
                profile quality. We focus on relevant lead distribution.
              </AccordionContent>
            </AccordionItem>
            ...
            >
              ...
              <AccordionContent className="text-soft-slate pb-6">
                Exclusivity can be discussed for strategic alliance
                partnerships.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
      ...
      <section className="py-16 bg-gray-50 border-t border-gray-200 text-center">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl md:text-5xl font-extrabold mb-8 text-primary-navy">
            Final Note
          </h2>
          <div className="max-w-3xl mx-auto">
            <p className="text-xl md:text-2xl font-light mb-8 text-primary-navy">
              Eventibe is not just a website. It is a growing event marketplace
              platform.
            </p>
            <p className="text-lg md:text-xl text-soft-slate mb-8 leading-relaxed">
              We are building with intention, structure, and long-term clarity.
              If you want to grow digitally, expand geographically, and align
              with a curated event ecosystem —
            </p>
            <motion.div whileHover={{ scale: 1.05 }} className="inline-block">
              <h3 className="text-4xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-accent-orange to-yellow-400 mb-8">
                Let’s partner.
              </h3>
            </motion.div>
            <div className="mt-4">
              <Button
                size="lg"
                className="bg-primary-navy text-white h-12 md:h-14 px-8 md:px-10 text-base md:text-lg font-bold rounded-xl hover:bg-primary-navy/90 active:scale-[0.98] transition-all"
              >
                Get Started Today
              </Button>
            </div>
