  ...
  try {
    ...
    return {
      ...
      openGraph: {
        title,
        description,
        url: `https://www.eventibe.com/venue/${slug}`,
        siteName: 'Eventibe',
        images: [
          {
            url: mainImage,
      ...
      alternates: {
        canonical: `https://www.eventibe.com/venue/${slug}`,
      },
      other: {
    ...
    return {
      title: 'Venue Details | Eventibe',
      description: 'Explore premium venues on Eventibe.'
    }
  }
}
